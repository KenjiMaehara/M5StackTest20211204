...
void main_scr_alarm(lv_ui *ui)
{
 //-------------------------------------------------------------------
  ...
  ui->main_tab1 = lv_tabview_add_tab(ui->main_tabview, "Tab 1");
  ui->main_tab2 = lv_tabview_add_tab(ui->main_tabview, "Tab 2");
  ui->main_tab3 = lv_tabview_add_tab(ui->main_tabview, "Tab 3");
  
  //-------------------------------------------------------------------
  /*Add content to the tabs*/
  ui->main_label = lv_label_create(NULL, NULL);
  ...
  ui->main_btn1 = lv_btn_create(ui->main_tab1, NULL);
  lv_obj_align(    ui->main_btn1, NULL, LV_ALIGN_CENTER, 0, -20);
  lv_obj_add_style(ui->main_btn1, LV_BTN_PART_MAIN, &style_gum);
  
  //-------------------------------------------------------------------
  /*Instead of creating a label add a values string*/
  lv_obj_set_style_local_value_str(ui->main_btn1, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, "Gum");
  ...
  ui->main_btn2 = lv_btn_create(ui->main_tab1, NULL);
  lv_obj_align(                     ui->main_btn2, NULL, LV_ALIGN_CENTER, 0, 60);
  lv_obj_add_style(                 ui->main_btn2, LV_BTN_PART_MAIN, &style_halo);
  lv_obj_set_style_local_value_str( ui->main_btn2, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, "Halo");
  ...
  ui->main_btn3 = lv_btn_create(ui->main_tab1, NULL);
  lv_obj_align(                    ui->main_btn3, NULL, LV_ALIGN_CENTER, 0, 140);
  lv_obj_add_style(                ui->main_btn3, LV_BTN_PART_MAIN, &style_ripple);
